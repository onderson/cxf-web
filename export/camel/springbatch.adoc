...
|`jobLauncherRef` |`null` |*Deprecated and will be removed in Camel
3.0!* *Camel 2.10:* Use jobLauncher=#theName instead.

|`jobLauncher` |`null` |*Camel 2.11.1:* Explicitly specifies a
`JobLauncher` to be used from the Camel link:registry.html[Registry].

|`jobFromHeader` |`false` |*Camel 2.18:* Explicitly defines if the
jobName shouls be taken from the headers instead of the URI. The header
has name: `CamelSpringBatchJobName`
|=======================================================================
