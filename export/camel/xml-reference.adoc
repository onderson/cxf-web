...
link:xml-configuration.html[Xml Configuration] with Camel releases. You
...
When you are using link:spring.html[Spring]'s 2.5 XML handling to parse
...
svn ci -m "Uploading released manuals for camel-2.17.4"
